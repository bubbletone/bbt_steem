...
FC_REFLECT( steemit::bbtone::offer_create_operation, (operator_name)(offer_id)(service_id)(service_ttl)(service_fee)(required_posting_auths) )
FC_REFLECT( steemit::bbtone::offer_cancel_operation, (operator_name)(offer_id)(required_posting_auths) )
